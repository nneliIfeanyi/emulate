...
<div class="row mb-3">
  <div class="col-lg-10 mx-auto">
    <h1 class="h6 mb-3 text-center text-muted">All Transactions For Current Week<span class="text-success"><?= date('W') ?></span></h1>
    <div class="row">
      <div class="col-md-6">
      ...
      <form action="<?php echo URLROOT?>/personal/current_week" method="POST">
        ...
        <div class="col-6 py-2 col-lg-4 form-group">
            <select class="form-control <?php echo (!empty($data['month_err'])) ? 'is-invalid' : ''; ?>" name="week">
              ...
              <option value="<?php echo $week->week?>"><?php echo 'week'.$week->week?></option>
              <?php endforeach;?>
            </select>
        </div>
...
<div>
  <p class="flash-msg"><?php echo flash('msg')?></p>
</div>
...
<script>
  new DataTable('#example', {
    caption:"All Recorded Transactions week <?= date('W') ?>",
    ordering:false,
    info:false,
});
</script>